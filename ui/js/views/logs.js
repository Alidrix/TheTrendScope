...
export async function refreshLogs() {
  try {
    ...
    $('summaryTab').innerHTML = `<div class="grid-kpi">${kpiCard('Total logs', summary.total_logs || 0)}${kpiCard('Erreurs', summary.by_level?.error || 0)}${kpiCard('Warnings', summary.by_level?.warning || 0)}${kpiCard('Dernier log', summary.last_log?.message || 'Aucun')}</div>`;
